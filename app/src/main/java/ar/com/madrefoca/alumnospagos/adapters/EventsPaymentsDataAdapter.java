...
public class EventsPaymentsDataAdapter extends RecyclerView.Adapter<EventsPaymentsDataAdapter.ViewHolder>{

    private ArrayList<Event> eventsList;
    private Context context;

    public EventsPaymentsDataAdapter(ArrayList eventsList, Context context) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Log.d("EventsPaymentsAdapter", "onClick " + eventsList.get(getPosition()).getName()+ " " + eventsList.get(getPosition()).getIdEvent());
            ManageFragmentsNavigation.setCurrentTag(ManageFragmentsNavigation.TAG_EVENT_ACCOUNTS);
